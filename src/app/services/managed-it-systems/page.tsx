      ...
      <div className="space-y-8">
        <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
                <Card>
                    ...
                    <div>
                        ...
                        <p className="text-black">QPC technicians have more than 60 years of combined experience across all areas of IT. We have one axiom that guides our approach. “High-value IT Service Delivery begins with careful IT Service Design.” Our customers get the most value from our services when they spend time being proactive, not reactive.</p>
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg text-primary mb-2">Platform</h3>
                        <p className="text-black">QPCTech can manage your Server platform whether it is a physical server, virtualized server, or a cloud-hosted virtual server. We can keep your servers healthy delivering business value reliably and effectively.</p>
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg text-primary mb-2">Applications</h3>
                        <p className="text-black">QPCTech supports a large and growing catalog of business applications. Here are a few that we work with regularly:</p>
                    </div>
                    </CardContent>
                </Card>
            </div>
          ...
          <Card>
            ...
            <CardContent>
                <ul className="columns-2 sm:columns-3 md:columns-4 gap-x-6 gap-y-2 list-disc list-outside pl-4">
                    {applications.map(app => <li key={app} className="text-sm break-inside-avoid list-item text-black">{app}</li>)}
                </ul>
            </CardContent>
          </Card>
           ...
           <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-black">At QPCTech, we design automated and monitored backups for our clients both onsite and cloud. Small businesses without a server still need to back up their PCs. OneDrive and Google Drive are often good choices, but implementation can be troublesome across multiple users and systems. Still, other customers prefer to stay out of the cloud as much as possible. For them, we can provide a Network Attached Storage (NAS). Synology makes some of our favorite NAS products along with a complement of user profile file replication products (similar to Dropbox or OneDrive). These Synology applications run “internally” on the customer’s hardware and their terms!</p>
              <p className="text-black">When it comes to managing these IT assets you can depend on QPCTech’s experience and knowledge of these vendors to help you stay on top of licensing, software updates patch management, and more.</p>
            </CardContent>
          </Card>
